 ...
 */
 define(['N/log', 'N/ui/serverWidget', 'N/runtime', 'N/search', 'N/url', 'N/redirect', 'N/record', 'N/task', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0'],
    function (log, serverWidget, runtime, search, url, redirect, record, task, library_mail) {
        ...
        var LANGUAGE = "";
        var SCRIPT_ID = "customscript_smc_ar_wht_void_pymt_stlt";
        var DEPLOY_ID = "customdeploy_smc_ar_wht_void_pymt_stlt";
        var MR_SCRIPT_ID = "customscript_smc_ar_wht_void_pymt_mr";
        var MR_DEPLOY_ID = "customdeploy_smc_ar_wht_void_pymt_mr";
                ...
                try {
                    ...
                    if (idLog) {
                        ...
                        var task_mr = task.create({
                            ...
                            params: {
                                'custscript_smc_ar_wht_void_idlog': idLog,
                                'custscript_smc_ar_wht_void_date' : cancellationDate
                            }
                        });
