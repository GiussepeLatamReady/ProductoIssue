 ...
 define(['N/log', 'N/runtime', 'N/search', 'N/record', 'N/format', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0'],
    function (log, runtime, search, record, format, library_mail) {
        ...
        function getInputData() {
            try {
                var idLog = runtime.getCurrentScript().getParameter({ name: 'custscript_smc_ar_wht_void_idlog' });
                
                var cancellationDate = runtime.getCurrentScript().getParameter({ name: 'custscript_smc_ar_wht_void_date' });
        ...
        function createTransactionFields(vendorCreditID, dateSICORE) {
            ...
            if (recordID) {
                record.submitFields({
                    ...
                    id: recordID,
                    values: {
                        "custrecord_smc_ar_date_report": dateSICORE
                    },
                    options: {
                        disableTriggers: true
                    }
                ...
                rec_transField.setValue({ fieldId: 'custrecord_smc_ar_date_report', value: dateSICORE })
