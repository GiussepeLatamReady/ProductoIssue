...
define(['N/config', 'N/log', 'N/ui/serverWidget', 'N/record', 'N/search', 'N/runtime', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0',
  ...
  function (config, log, serverWidget, record, search, runtime, library, library_HideView, Library_CusTransfer, libraryGLImpact, Library_ExchangeRate_Field, Library_DIOT) {
      ...
      try {
        ...
        if (type == 'view' || type == 'edit') {
          if (!validateAdvanceHV(LMRY_Result[0], licenses)) {
            library_HideView.HideColumn(scriptContext.form, recordObj.getText('custbody_lmry_subsidiary_country'), recordObj.type, licenses);
          }
          if (LMRY_Result[0] == 'PE') {
